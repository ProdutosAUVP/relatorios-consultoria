...
Campos exclusivos da variante **alan-santanna** (1):

```
data_apresentacao
```

Campos exclusivos da variante **alta-renda** (45):

```
certificacao_1                    certificacao_2                    certificacao_3
data_apresentacao                 email_consultor                   especializacao_1
especializacao_2                  fora_do_escritorio                formacao_1
formacao_2                        frase_consultor                   funciona_1
funciona_2                        funciona_3                        incluido_1
...
marco_3_texto                     nao_incluido_1                    nao_incluido_2
nao_incluido_3                    nao_incluido_4                    nome_consultor
nome_plano                        notas_de_rodape                   papel_consultor
plano_resumo                      proposito_1                       proposito_2
taxa_anual                        taxa_mensal                       whatsapp_consultor
```

Campos exclusivos da variante **andre-arruda** (1):
...
Campos exclusivos da variante **bolivar-oliveira-sem-data** (1):

```
whatsapp_consultor
```

Campos exclusivos da variante **bolivar-oliveira** (2):

```
data_apresentacao                 whatsapp_consultor
```

Campos exclusivos da variante **danilo-barbosa** (1):

```
data_apresentacao
```

Campos exclusivos da variante **erika-barreto** (1):

```
data_apresentacao
```

Campos exclusivos da variante **me-diz-o-que-fazer** (26):

```
certificacao_1                    certificacao_2                    certificacao_3
data_apresentacao                 email_consultor                   especializacao_1
especializacao_2                  fora_do_escritorio                formacao_1
formacao_2                        frase_consultor                   interesse_1
...
Campos exclusivos da variante **nasser-tanure** (1):

```
data_apresentacao
```

Campos exclusivos da variante **private** (45):
...
Campos exclusivos da variante **resolve-ai** (26):
...
Campos exclusivos da variante **se-vira-ai** (26):
